...
namespace DAPOS
{
	public class AGGroupRoleCollection :Collection<AGGroupRole>, IEnumerable<AGGroupRole>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private AGGroupRoleCollection t;

			public Enumerator (AGGroupRoleCollection t)
			{
				this.t = t;
			}
		...
		{
			return new AGGroupRoleCollection.Enumerator(this);
		}
