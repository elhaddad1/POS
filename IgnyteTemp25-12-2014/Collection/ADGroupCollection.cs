...
namespace DAPOS
{
	public class ADGroupCollection :Collection<ADGroup>, IEnumerable<ADGroup>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private ADGroupCollection t;

			public Enumerator (ADGroupCollection t)
			{
				this.t = t;
			}
		...
		{
			return new ADGroupCollection.Enumerator(this);
		}
