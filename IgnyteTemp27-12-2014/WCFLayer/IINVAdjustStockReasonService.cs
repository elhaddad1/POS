//
// Class	:	IINVAdjustStockReasonService.cs
...
namespace POS.BusinessLayer
{
	...
	///</summary>
	[ServiceContract]
	public interface IINVAdjustStockReasonService
	{
		///<summary>
		...
		[OperationContract]
		bool Delete(INVAdjustStockReasonPrimaryKey pk);
		...
		[OperationContract]
		INVAdjustStockReason SelectOne(INVAdjustStockReasonPrimaryKey pk);
		...
		[OperationContract]
		INVAdjustStockReasonCollection SelectAll();
    ...
    /// <summary>
		...
		[OperationContract]
		INVAdjustStockReasonCollection SelectByField(string field, object fieldValue,object fielValue2, TypeOperation typeOperation);	
		
		
		///<summary>
		///This method will insert one row into the database using the object
		///</summary>
		///<param name="POS.DataLayer" type="INVAdjustStockReason">This INVAdjustStockReason  will be inserted in the database.</param>
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Insert(INVAdjustStockReason POS.DataLayer);
	...
	///	<summary>
		...
		[OperationContract]
		INVAdjustStockReasonCollection SelectAllPaged(int? pageSize, int? skipPages, string orderByStatement);
		...
		/// <returns>List of object of class INVAdjustStockReason in the form of an object of class INVAdjustStockReasonCollection</returns>
		[OperationContract]
		INVAdjustStockReasonCollection SelectByFieldPaged(string field, object fieldValue, object fieldValue2, TypeOperation typeOperation, int pageSize, int skipPages, string orderByStatement);
			///<summary>
		...
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Update(INVAdjustStockReason iNVAdjustStockReason);
	} 
}
