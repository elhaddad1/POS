//
// Class	:	IINVTakingInventoryLineService.cs
...
namespace POS.BusinessLayer
{
	...
	///</summary>
	[ServiceContract]
	public interface IINVTakingInventoryLineService
	{
		///<summary>
		...
		[OperationContract]
		bool Delete(INVTakingInventoryLinePrimaryKey pk);
		...
		[OperationContract]
		INVTakingInventoryLine SelectOne(INVTakingInventoryLinePrimaryKey pk);
		...
		[OperationContract]
		INVTakingInventoryLineCollection SelectAll();
    ...
    /// <summary>
		...
		[OperationContract]
		INVTakingInventoryLineCollection SelectByField(string field, object fieldValue,object fielValue2, TypeOperation typeOperation);	
		
		
		///<summary>
		///This method will insert one row into the database using the object
		///</summary>
		///<param name="POS.DataLayer" type="INVTakingInventoryLine">This INVTakingInventoryLine  will be inserted in the database.</param>
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Insert(INVTakingInventoryLine POS.DataLayer);
	...
	///	<summary>
		...
		[OperationContract]
		INVTakingInventoryLineCollection SelectAllPaged(int? pageSize, int? skipPages, string orderByStatement);
		...
		/// <returns>List of object of class INVTakingInventoryLine in the form of an object of class INVTakingInventoryLineCollection</returns>
		[OperationContract]
		INVTakingInventoryLineCollection SelectByFieldPaged(string field, object fieldValue, object fieldValue2, TypeOperation typeOperation, int pageSize, int skipPages, string orderByStatement);
			///<summary>
		...
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Update(INVTakingInventoryLine iNVTakingInventoryLine);
	} 
}
