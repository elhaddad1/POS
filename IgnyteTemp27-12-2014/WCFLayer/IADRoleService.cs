...
namespace POS.BusinessLayer
{
	...
	public interface IADRoleService
	{
		...
		[OperationContract]
		bool Delete(ADRolePrimaryKey pk);
		...
		[OperationContract]
		ADRole SelectOne(ADRolePrimaryKey pk);
    ...
    /// <summary>
		...
		[OperationContract]
		ADRoleCollection SelectByField(string field, object fieldValue,object fielValue2, TypeOperation typeOperation);	
		
		
		///<summary>
		///This method will insert one row into the database using the object
		///</summary>
		///<param name="POS.DataLayer" type="ADRole">This ADRole  will be inserted in the database.</param>
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Insert(ADRole POS.DataLayer);
	...
	///	<summary>
		...
		[OperationContract]
		ADRoleCollection SelectAllPaged(int? pageSize, int? skipPages, string orderByStatement);
		...
		/// <returns>List of object of class ADRole in the form of an object of class ADRoleCollection</returns>
		[OperationContract]
		ADRoleCollection SelectByFieldPaged(string field, object fieldValue, object fieldValue2, TypeOperation typeOperation, int pageSize, int skipPages, string orderByStatement);
			///<summary>
