...
namespace POS.BusinessLayer
{
	...
	public interface IADGroupService
	{
		...
		[OperationContract]
		bool Delete(ADGroupPrimaryKey pk);
		...
		[OperationContract]
		ADGroup SelectOne(ADGroupPrimaryKey pk);
    ...
    /// <summary>
		...
		[OperationContract]
		ADGroupCollection SelectByField(string field, object fieldValue,object fielValue2, TypeOperation typeOperation);	
		
		
		///<summary>
		///This method will insert one row into the database using the object
		///</summary>
		///<param name="POS.DataLayer" type="ADGroup">This ADGroup  will be inserted in the database.</param>
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Insert(ADGroup POS.DataLayer);
	...
	///	<summary>
		...
		[OperationContract]
		ADGroupCollection SelectAllPaged(int? pageSize, int? skipPages, string orderByStatement);
		...
		/// <returns>List of object of class ADGroup in the form of an object of class ADGroupCollection</returns>
		[OperationContract]
		ADGroupCollection SelectByFieldPaged(string field, object fieldValue, object fieldValue2, TypeOperation typeOperation, int pageSize, int skipPages, string orderByStatement);
			///<summary>
