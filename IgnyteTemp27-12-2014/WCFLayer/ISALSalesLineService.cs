...
namespace POS.BusinessLayer
{
	...
	///</summary>
	[ServiceContract]
	public interface ISALSalesLineService
	{
		///<summary>
		...
		[OperationContract]
		bool Delete(SALSalesLinePrimaryKey pk);
		...
		[OperationContract]
		SALSalesLine SelectOne(SALSalesLinePrimaryKey pk);
		...
		[OperationContract]
		SALSalesLineCollection SelectAll();
    ...
    /// <summary>
		...
		[OperationContract]
		SALSalesLineCollection SelectByField(string field, object fieldValue,object fielValue2, TypeOperation typeOperation);	
		
		
		///<summary>
		///This method will insert one row into the database using the object
		///</summary>
		///<param name="POS.DataLayer" type="SALSalesLine">This SALSalesLine  will be inserted in the database.</param>
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Insert(SALSalesLine POS.DataLayer);
	...
	///	<summary>
		...
		[OperationContract]
		SALSalesLineCollection SelectAllPaged(int? pageSize, int? skipPages, string orderByStatement);
		...
		/// <returns>List of object of class SALSalesLine in the form of an object of class SALSalesLineCollection</returns>
		[OperationContract]
		SALSalesLineCollection SelectByFieldPaged(string field, object fieldValue, object fieldValue2, TypeOperation typeOperation, int pageSize, int skipPages, string orderByStatement);
			///<summary>
		...
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Update(SALSalesLine sALSalesLine);
	} 
}
