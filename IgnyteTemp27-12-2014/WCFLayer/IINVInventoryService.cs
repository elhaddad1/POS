...
namespace POS.BusinessLayer
{
	...
	///</summary>
	[ServiceContract]
	public interface IINVInventoryService
	{
		///<summary>
		...
		[OperationContract]
		bool Delete(INVInventoryPrimaryKey pk);
		...
		[OperationContract]
		INVInventory SelectOne(INVInventoryPrimaryKey pk);
		...
		[OperationContract]
		INVInventoryCollection SelectAll();
    ...
    /// <summary>
		...
		[OperationContract]
		INVInventoryCollection SelectByField(string field, object fieldValue,object fielValue2, TypeOperation typeOperation);	
		
		
		///<summary>
		///This method will insert one row into the database using the object
		///</summary>
		///<param name="POS.DataLayer" type="INVInventory">This INVInventory  will be inserted in the database.</param>
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Insert(INVInventory POS.DataLayer);
	...
	///	<summary>
		...
		[OperationContract]
		INVInventoryCollection SelectAllPaged(int? pageSize, int? skipPages, string orderByStatement);
		...
		/// <returns>List of object of class INVInventory in the form of an object of class INVInventoryCollection</returns>
		[OperationContract]
		INVInventoryCollection SelectByFieldPaged(string field, object fieldValue, object fieldValue2, TypeOperation typeOperation, int pageSize, int skipPages, string orderByStatement);
			///<summary>
		...
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Update(INVInventory iNVInventory);
	} 
}
