//
// Class	:	ISALSalesReturnLineService.cs
...
namespace POS.BusinessLayer
{
	...
	///</summary>
	[ServiceContract]
	public interface ISALSalesReturnLineService
	{
		///<summary>
		...
		[OperationContract]
		bool Delete(SALSalesReturnLinePrimaryKey pk);
		...
		[OperationContract]
		SALSalesReturnLine SelectOne(SALSalesReturnLinePrimaryKey pk);
		...
		[OperationContract]
		SALSalesReturnLineCollection SelectAll();
    ...
    /// <summary>
		...
		[OperationContract]
		SALSalesReturnLineCollection SelectByField(string field, object fieldValue,object fielValue2, TypeOperation typeOperation);	
		
		
		///<summary>
		///This method will insert one row into the database using the object
		///</summary>
		///<param name="POS.DataLayer" type="SALSalesReturnLine">This SALSalesReturnLine  will be inserted in the database.</param>
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Insert(SALSalesReturnLine POS.DataLayer);
	...
	///	<summary>
		...
		[OperationContract]
		SALSalesReturnLineCollection SelectAllPaged(int? pageSize, int? skipPages, string orderByStatement);
		...
		/// <returns>List of object of class SALSalesReturnLine in the form of an object of class SALSalesReturnLineCollection</returns>
		[OperationContract]
		SALSalesReturnLineCollection SelectByFieldPaged(string field, object fieldValue, object fieldValue2, TypeOperation typeOperation, int pageSize, int skipPages, string orderByStatement);
			///<summary>
		...
		/// <returns>True if succeeded</returns>
		[OperationContract]
		bool Update(SALSalesReturnLine sALSalesReturnLine);
	} 
}
