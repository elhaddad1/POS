...
{
	public class INVProductStockCollection :Collection<INVProductStock>, IEnumerable<INVProductStock>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private INVProductStockCollection t;
		...
		public void Sort(string sortingExpression)
		{
			...
			INVProductStock[] elements =new INVProductStock[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(INVProductStock item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new INVProductStockCollection.Enumerator(this);
		}
