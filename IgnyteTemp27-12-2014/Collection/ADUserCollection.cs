...
{
	public class ADUserCollection :Collection<ADUser>, IEnumerable<ADUser>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private ADUserCollection t;

			public Enumerator (ADUserCollection t)
			{
				this.t = t;
			}
		...
		{
			return new ADUserCollection.Enumerator(this);
		}
