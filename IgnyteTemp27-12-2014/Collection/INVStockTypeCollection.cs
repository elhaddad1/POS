...
{
	public class INVStockTypeCollection :Collection<INVStockType>, IEnumerable<INVStockType>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private INVStockTypeCollection t;

			public Enumerator (INVStockTypeCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			INVStockType[] elements =new INVStockType[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(INVStockType item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new INVStockTypeCollection.Enumerator(this);
		}
