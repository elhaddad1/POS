...
namespace DAPOS
{
	...
	#region Constructors / Destructors
		...
		/// </summary>
		public INVAdjustStockReasonPrimaryKey(int? adjustStockReasonID) 
		{
	
			
			this._adjustStockReasonIDNonDefault = adjustStockReasonID;
	...
	#region Properties
		...
		/// <summary>
		/// This property is mapped to the "AdjustStockReasonID" field.  Mandatory.
		/// </summary>
	...
	#region Methods (Public)
		...
		public NameValueCollection GetKeysAndValues() 
		{
			...
			nvc.Add("AdjustStockReasonID",_adjustStockReasonIDNonDefault.ToString());
			return nvc;
