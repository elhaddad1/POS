...
{
	public class PURPurchaseReturnLineCollection :Collection<PURPurchaseReturnLine>, IEnumerable<PURPurchaseReturnLine>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private PURPurchaseReturnLineCollection t;

			public Enumerator (PURPurchaseReturnLineCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			PURPurchaseReturnLine[] elements =new PURPurchaseReturnLine[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(PURPurchaseReturnLine item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new PURPurchaseReturnLineCollection.Enumerator(this);
		}
