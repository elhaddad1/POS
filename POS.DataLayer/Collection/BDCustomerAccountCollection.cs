...
{
	public class BDCustomerAccountCollection :Collection<BDCustomerAccount>, IEnumerable<BDCustomerAccount>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private BDCustomerAccountCollection t;

			public Enumerator (BDCustomerAccountCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			BDCustomerAccount[] elements =new BDCustomerAccount[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BDCustomerAccount item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BDCustomerAccountCollection.Enumerator(this);
		}
