...
namespace DAPOS
{
	public class BDTaxTypeCollection :Collection<BDTaxType>, IEnumerable<BDTaxType>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private BDTaxTypeCollection t;

			public Enumerator (BDTaxTypeCollection t)
			{
				this.t = t;
			}
		...
		{
			return new BDTaxTypeCollection.Enumerator(this);
		}
