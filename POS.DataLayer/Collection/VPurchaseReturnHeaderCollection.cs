...
{
	public class VPurchaseReturnHeaderCollection :Collection<VPurchaseReturnHeader>, IEnumerable<VPurchaseReturnHeader>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private VPurchaseReturnHeaderCollection t;

			public Enumerator (VPurchaseReturnHeaderCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			VPurchaseReturnHeader[] elements =new VPurchaseReturnHeader[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(VPurchaseReturnHeader item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new VPurchaseReturnHeaderCollection.Enumerator(this);
		}
