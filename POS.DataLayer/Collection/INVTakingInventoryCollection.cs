//
// Class	:	INVTakingInventoryCollection.cs
...
namespace DAPOS
{
	public class INVTakingInventoryCollection :Collection<INVTakingInventory>, IEnumerable<INVTakingInventory>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private INVTakingInventoryCollection t;

			public Enumerator (INVTakingInventoryCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			INVTakingInventory[] elements =new INVTakingInventory[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(INVTakingInventory item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new INVTakingInventoryCollection.Enumerator(this);
		}
