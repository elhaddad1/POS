...
{
	public class INVInventoryCollection :Collection<INVInventory>, IEnumerable<INVInventory>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private INVInventoryCollection t;

			public Enumerator (INVInventoryCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			INVInventory[] elements =new INVInventory[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(INVInventory item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new INVInventoryCollection.Enumerator(this);
		}
