...
{
	public class VUserRoleCollection :Collection<VUserRole>, IEnumerable<VUserRole>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private VUserRoleCollection t;

			public Enumerator (VUserRoleCollection t)
			{
				this.t = t;
			}
		...
		{
			return new VUserRoleCollection.Enumerator(this);
		}
