...
{
	public class BDSupplierCollection :Collection<BDSupplier>, IEnumerable<BDSupplier>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private BDSupplierCollection t;

			public Enumerator (BDSupplierCollection t)
			{
				this.t = t;
			}
		...
		{
			return new BDSupplierCollection.Enumerator(this);
		}
