...
{
	public class INVTakingInventoryLineBatchCollection :Collection<INVTakingInventoryLineBatch>, IEnumerable<INVTakingInventoryLineBatch>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private INVTakingInventoryLineBatchCollection t;

			public Enumerator (INVTakingInventoryLineBatchCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			INVTakingInventoryLineBatch[] elements =new INVTakingInventoryLineBatch[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(INVTakingInventoryLineBatch item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new INVTakingInventoryLineBatchCollection.Enumerator(this);
		}
