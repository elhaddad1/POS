...
{
	public class ADGroupRoleCollection :Collection<ADGroupRole>, IEnumerable<ADGroupRole>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private ADGroupRoleCollection t;

			public Enumerator (ADGroupRoleCollection t)
			{
				this.t = t;
			}
		...
		{
			return new ADGroupRoleCollection.Enumerator(this);
		}
