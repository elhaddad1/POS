...
namespace POS.DataLayer
{
	public class PURPurchaseHeaderCollection :Collection<PURPurchaseHeader>, IEnumerable<PURPurchaseHeader>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private PURPurchaseHeaderCollection t;

			public Enumerator (PURPurchaseHeaderCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			PURPurchaseHeader[] elements =new PURPurchaseHeader[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(PURPurchaseHeader item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new PURPurchaseHeaderCollection.Enumerator(this);
		}
