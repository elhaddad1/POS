//
// Class	:	PaymentTypeCollection.cs
...
{
	public class PaymentTypeCollection :Collection<PaymentType>, IEnumerable<PaymentType>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private PaymentTypeCollection t;

			public Enumerator (PaymentTypeCollection t)
			{
				this.t = t;
			}
		...
		{
			return new PaymentTypeCollection.Enumerator(this);
		}
