...
{
	public class PURPurchaseLineCollection :Collection<PURPurchaseLine>, IEnumerable<PURPurchaseLine>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private PURPurchaseLineCollection t;

			public Enumerator (PURPurchaseLineCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			PURPurchaseLine[] elements =new PURPurchaseLine[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(PURPurchaseLine item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new PURPurchaseLineCollection.Enumerator(this);
		}
