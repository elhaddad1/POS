...
{
	public class SALSalesLineCollection :Collection<SALSalesLine>, IEnumerable<SALSalesLine>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private SALSalesLineCollection t;

			public Enumerator (SALSalesLineCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			SALSalesLine[] elements =new SALSalesLine[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(SALSalesLine item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new SALSalesLineCollection.Enumerator(this);
		}
