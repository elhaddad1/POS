...
{
	public class INVTakingInventoryLineCollection :Collection<INVTakingInventoryLine>, IEnumerable<INVTakingInventoryLine>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private INVTakingInventoryLineCollection t;

			public Enumerator (INVTakingInventoryLineCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			INVTakingInventoryLine[] elements =new INVTakingInventoryLine[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(INVTakingInventoryLine item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new INVTakingInventoryLineCollection.Enumerator(this);
		}
