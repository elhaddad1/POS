...
{
	public class VProductCollection :Collection<VProduct>, IEnumerable<VProduct>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private VProductCollection t;

			public Enumerator (VProductCollection t)
			{
				this.t = t;
			}
		...
		{
			return new VProductCollection.Enumerator(this);
		}
