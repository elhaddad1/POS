...
{
	public class BDSupplierAccountCollection :Collection<BDSupplierAccount>, IEnumerable<BDSupplierAccount>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private BDSupplierAccountCollection t;

			public Enumerator (BDSupplierAccountCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			BDSupplierAccount[] elements =new BDSupplierAccount[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BDSupplierAccount item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BDSupplierAccountCollection.Enumerator(this);
		}
