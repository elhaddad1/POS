...
namespace DAPOS
{
	public class INVProductStockBatchCollection :Collection<INVProductStockBatch>, IEnumerable<INVProductStockBatch>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private INVProductStockBatchCollection t;

			public Enumerator (INVProductStockBatchCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			INVProductStockBatch[] elements =new INVProductStockBatch[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(INVProductStockBatch item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new INVProductStockBatchCollection.Enumerator(this);
		}
