...
{
	public class BDCustomerCollection :Collection<BDCustomer>, IEnumerable<BDCustomer>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private BDCustomerCollection t;
		...
		{
			return new BDCustomerCollection.Enumerator(this);
		}
