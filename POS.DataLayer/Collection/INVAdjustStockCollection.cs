...
{
	public class INVAdjustStockCollection :Collection<INVAdjustStock>, IEnumerable<INVAdjustStock>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private INVAdjustStockCollection t;

			public Enumerator (INVAdjustStockCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			INVAdjustStock[] elements =new INVAdjustStock[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(INVAdjustStock item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new INVAdjustStockCollection.Enumerator(this);
		}
