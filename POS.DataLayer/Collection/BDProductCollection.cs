...
{
	public class BDProductCollection :Collection<BDProduct>, IEnumerable<BDProduct>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private BDProductCollection t;

			public Enumerator (BDProductCollection t)
			{
				this.t = t;
			}
		...
		{
			return new BDProductCollection.Enumerator(this);
		}
