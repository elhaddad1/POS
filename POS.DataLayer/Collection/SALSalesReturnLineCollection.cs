...
{
	public class SALSalesReturnLineCollection :Collection<SALSalesReturnLine>, IEnumerable<SALSalesReturnLine>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private SALSalesReturnLineCollection t;

			public Enumerator (SALSalesReturnLineCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			SALSalesReturnLine[] elements =new SALSalesReturnLine[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(SALSalesReturnLine item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new SALSalesReturnLineCollection.Enumerator(this);
		}
