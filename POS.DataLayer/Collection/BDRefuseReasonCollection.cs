//
// Class	:	BDRefuseReasonCollection.cs
...
{
	public class BDRefuseReasonCollection :Collection<BDRefuseReason>, IEnumerable<BDRefuseReason>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private BDRefuseReasonCollection t;

			public Enumerator (BDRefuseReasonCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			BDRefuseReason[] elements =new BDRefuseReason[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BDRefuseReason item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BDRefuseReasonCollection.Enumerator(this);
		}
