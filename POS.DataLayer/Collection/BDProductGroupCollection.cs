...
namespace POS.DataLayer
{
	public class BDProductGroupCollection :Collection<BDProductGroup>, IEnumerable<BDProductGroup>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private BDProductGroupCollection t;

			public Enumerator (BDProductGroupCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			BDProductGroup[] elements =new BDProductGroup[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(BDProductGroup item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new BDProductGroupCollection.Enumerator(this);
		}
