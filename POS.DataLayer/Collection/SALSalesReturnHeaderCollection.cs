...
{
	public class SALSalesReturnHeaderCollection :Collection<SALSalesReturnHeader>, IEnumerable<SALSalesReturnHeader>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private SALSalesReturnHeaderCollection t;

			public Enumerator (SALSalesReturnHeaderCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			SALSalesReturnHeader[] elements =new SALSalesReturnHeader[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(SALSalesReturnHeader item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new SALSalesReturnHeaderCollection.Enumerator(this);
		}
