...
namespace POS.DataLayer
{
    ...
    public class INVInventoryBase
    {
        ...
        private INVTakingInventoryCollection _iNVTakingInventoryCollectionInventoryID = null;
        private INVProductStockCollection _iNVProductStockCollectionInventoryID = null;
        ...
        /// <summary>
        /// Provides access to the related table 'INVTakingInventory'
        /// </summary>
        public INVTakingInventoryCollection INVTakingInventoryCollectionUsingInventoryID
        {
            get
            {
                if (_iNVTakingInventoryCollectionInventoryID == null)
                {
                    _iNVTakingInventoryCollectionInventoryID = new INVTakingInventoryCollection();
                    _iNVTakingInventoryCollectionInventoryID = INVTakingInventory.SelectByField("InventoryID", InventoryID, null, TypeOperation.Equal);
                }
                return _iNVTakingInventoryCollectionInventoryID;
            }
            set
            {
                _iNVTakingInventoryCollectionInventoryID = value;
            }
        }
        ...
        /// </summary>
        public INVProductStockCollection INVProductStockCollectionUsingInventoryID
        {
            get
            {
                if (_iNVProductStockCollectionInventoryID == null)
                {
                    _iNVProductStockCollectionInventoryID = new INVProductStockCollection();
                    _iNVProductStockCollectionInventoryID = INVProductStock.SelectByField("InventoryID", InventoryID, null, TypeOperation.Equal);
                }
                return _iNVProductStockCollectionInventoryID;
            }
            set
            {
                _iNVProductStockCollectionInventoryID = value;
            }
        }
        ...
        /// DLGenerator			2/20/2015 7:03:49 PM		Created function
        /// 
        /// </RevisionHistory>
        ///
        /// </remarks>
        ...
        /// </remarks>
        ///
        public static INVInventory SelectOneWithINVTakingInventoryUsingInventoryID(INVInventoryPrimaryKey pk)
        {
            DatabaseHelper oDatabaseHelper = new DatabaseHelper();
            bool ExecutionState = false;
            ...
            IDataReader dr = oDatabaseHelper.ExecuteReader("gsp_INVInventory_SelectOneWithINVTakingInventoryUsingInventoryID", ref ExecutionState);
            if (dr.Read())
            {
                ...
                obj.INVTakingInventoryCollectionUsingInventoryID = INVTakingInventory.PopulateObjectsFromReader(dr);
            }
            dr.Close();
            oDatabaseHelper.Dispose();
            return obj;
        ...
        /// </remarks>
        ///
        public static INVInventory SelectOneWithINVProductStockUsingInventoryID(INVInventoryPrimaryKey pk)
        {
            DatabaseHelper oDatabaseHelper = new DatabaseHelper();
            bool ExecutionState = false;
            INVInventory obj = null;
            ...
            IDataReader dr = oDatabaseHelper.ExecuteReader("gsp_INVInventory_SelectOneWithINVProductStockUsingInventoryID", ref ExecutionState);
            if (dr.Read())
            {
                obj = new INVInventory();
                PopulateObjectFromReader(obj, dr);
                ...
                //Get the child records.
                obj.INVProductStockCollectionUsingInventoryID = INVProductStock.PopulateObjectsFromReader(dr);
            }
            dr.Close();
            oDatabaseHelper.Dispose();
            return obj;
