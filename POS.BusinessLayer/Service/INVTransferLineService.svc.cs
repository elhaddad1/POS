...
namespace POS.BusinessLayer
{
    ...
    /// <summary>
		...
		{
			return POS.DataLayer.INVTransferLineBase.DeleteAllByForeignKeyProductID(new POS.DataLayer.BDProductPrimaryKey(pk.ProductID));
		}
		...
		public INVTransferLineCollection SelectAllByForeignKeyProductID(BDProductPrimaryKey pk)
		{
			INVTransferLineCollection iNVTransferLineCollection=new INVTransferLineCollection();
			foreach (POS.DataLayer.INVTransferLine _iNVTransferLine in POS.DataLayer.INVTransferLineBase.SelectAllByForeignKeyProductID(new POS.DataLayer.BDProductPrimaryKey(pk.ProductID)))
			{
				_iNVTransferLineWCF = new INVTransferLine();
				_iNVTransferLineWCF.TransferLineID = _iNVTransferLine.TransferLineID;
				_iNVTransferLineWCF.TransferHeaderID = _iNVTransferLine.TransferHeaderID;
		...
		///
		/// <returns>object of class INVTransferLineCollection</returns>
		public INVTransferLineCollection SelectAllByForeignKeyProductIDPaged(BDProductPrimaryKey pk, int pageSize, int skipPages, string orderByStatement)
		{
			INVTransferLineCollection iNVTransferLineCollection=new INVTransferLineCollection();
			foreach (POS.DataLayer.INVTransferLine _iNVTransferLine in POS.DataLayer.INVTransferLineBase.SelectAllByForeignKeyProductIDPaged(new POS.DataLayer.BDProductPrimaryKey(pk.ProductID), pageSize, skipPages, orderByStatement))
			{
				_iNVTransferLineWCF = new INVTransferLine();
				_iNVTransferLineWCF.TransferLineID = _iNVTransferLine.TransferLineID;
				_iNVTransferLineWCF.TransferHeaderID = _iNVTransferLine.TransferHeaderID;
		...
		///
		/// <returns>True if succeeded</returns>
		public bool DeleteAllByForeignKeyTransferHeaderID(INVTransferHeaderPrimaryKey pk)
		{
			return POS.DataLayer.INVTransferLineBase.DeleteAllByForeignKeyTransferHeaderID(new POS.DataLayer.INVTransferHeaderPrimaryKey(pk.INVTransferHeaderID));
		}
		...
		///
		/// <returns>object of class INVTransferLineCollection</returns>
		public INVTransferLineCollection SelectAllByForeignKeyTransferHeaderID(INVTransferHeaderPrimaryKey pk)
		{
			INVTransferLineCollection iNVTransferLineCollection=new INVTransferLineCollection();
			foreach (POS.DataLayer.INVTransferLine _iNVTransferLine in POS.DataLayer.INVTransferLineBase.SelectAllByForeignKeyTransferHeaderID(new POS.DataLayer.INVTransferHeaderPrimaryKey(pk.INVTransferHeaderID)))
			{
				_iNVTransferLineWCF = new INVTransferLine();
				_iNVTransferLineWCF.TransferLineID = _iNVTransferLine.TransferLineID;
				_iNVTransferLineWCF.TransferHeaderID = _iNVTransferLine.TransferHeaderID;
		...
		///
		/// <returns>object of class INVTransferLineCollection</returns>
		public INVTransferLineCollection SelectAllByForeignKeyTransferHeaderIDPaged(INVTransferHeaderPrimaryKey pk, int pageSize, int skipPages, string orderByStatement)
		{
			INVTransferLineCollection iNVTransferLineCollection=new INVTransferLineCollection();
			foreach (POS.DataLayer.INVTransferLine _iNVTransferLine in POS.DataLayer.INVTransferLineBase.SelectAllByForeignKeyTransferHeaderIDPaged(new POS.DataLayer.INVTransferHeaderPrimaryKey(pk.INVTransferHeaderID), pageSize, skipPages, orderByStatement))
			{
				_iNVTransferLineWCF = new INVTransferLine();
				_iNVTransferLineWCF.TransferLineID = _iNVTransferLine.TransferLineID;
				_iNVTransferLineWCF.TransferHeaderID = _iNVTransferLine.TransferHeaderID;
