...
namespace DAPOS
{
	public class INVTransferHeaderCollection :Collection<INVTransferHeader>, IEnumerable<INVTransferHeader>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private INVTransferHeaderCollection t;

			public Enumerator (INVTransferHeaderCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			INVTransferHeader[] elements =new INVTransferHeader[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(INVTransferHeader item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new INVTransferHeaderCollection.Enumerator(this);
		}
