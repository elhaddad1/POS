//
// Class	:	INVAdjustStockReasonCollection.cs
...
namespace DAPOS
{
	public class INVAdjustStockReasonCollection :Collection<INVAdjustStockReason>, IEnumerable<INVAdjustStockReason>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private INVAdjustStockReasonCollection t;

			public Enumerator (INVAdjustStockReasonCollection t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			INVAdjustStockReason[] elements =new INVAdjustStockReason[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(INVAdjustStockReason item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new INVAdjustStockReasonCollection.Enumerator(this);
		}
