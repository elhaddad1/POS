...
namespace DAPOS
{
	public class ADRoleCollection :Collection<ADRole>, IEnumerable<ADRole>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private ADRoleCollection t;

			public Enumerator (ADRoleCollection t)
			{
				this.t = t;
			}
		...
		{
			return new ADRoleCollection.Enumerator(this);
		}
